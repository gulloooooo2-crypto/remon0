...
\x1b[1;92m-----------------------------------------------
\x1b[1;92m Owner  : REMON HORA
\x1b[1;92m Github : REMON-XD
\x1b[1;92m Facebok: RE MON
\x1b[1;92m Tool   : Auto create facebook
\x1b[0;92m-----------------------------------------------"""
boy = ['Rahul Don', 'Sandesh Magar', 'Ramit Hero', 'Sujan Don', 'Saroj Gurung', 'Robin Hero', 'Saimon Hora', 'Dinesh Kumar', 'Akash Hora', 'Romzan Hero', 'Mohan Tamang', 'Sagar Rai', 'Sangam Tamang', 'Pradeep Khatri', 'Arjun Xettri', 'Anmol Tamang', 'Sandip Hora', 'Kabir T Magar', 'Sameer Chaudhary', 'Purna Limbu', 'Sudip Magar']
girl = ['Sajina Don', 'Ayesha Chaudhary', 'Sarita Gurung', 'Magar Karina', 'Arju Xettri', 'Muskan Tamang', 'Ayesha Magar', 'Sabina Gurung', 'Isma Magar', 'Rimansa Tamang']
ok = []
cp = []
def menu():
    os.system('clear')
